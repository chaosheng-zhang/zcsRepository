...
import com.company.project.common.datasource.DynamicDataSource;
...
public class MyBatisConfig {
	...
	@Bean
	public DataSource sangDataSource() throws Exception {
		Properties props = new Properties();
	...
	public DynamicDataSource dataSource(@Qualifier("testDataSource") DataSource testDataSource,
			@Qualifier("sangDataSource") DataSource sangDataSource) {
		Map<Object, Object> targetDataSources = new HashMap<>();
		targetDataSources.put(DatabaseType.test, testDataSource);
		targetDataSources.put(DatabaseType.sang, sangDataSource);

		DynamicDataSource dataSource = new DynamicDataSource();
		dataSource.setTargetDataSources(targetDataSources);// 该方法是AbstractRoutingDataSource的方法
		dataSource.setDefaultTargetDataSource(testDataSource);// 默认的datasource设置为testDataSource
	...
	public SqlSessionFactory sqlSessionFactory(@Qualifier("testDataSource") DataSource testDataSource,
			@Qualifier("sangDataSource") DataSource sangDataSource) throws Exception {
		SqlSessionFactoryBean fb = new SqlSessionFactoryBean();
		fb.setDataSource(this.dataSource(testDataSource, sangDataSource));// 指定数据源(这个必须有，否则报错)
